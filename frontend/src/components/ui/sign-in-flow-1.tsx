    ...
    <header className={`fixed top-6 left-1/2 transform -translate-x-1/2 z-20 flex flex-col items-center pl-6 pr-6 py-3 backdrop-blur-sm ${headerShapeClass} border border-[#333] bg-[#1f1f1f57] w-[calc(100%-2rem)] sm:w-auto transition-[border-radius] duration-0 ease-in-out`}>
      <div className="flex items-center justify-between w-full gap-x-6 sm:gap-x-8">
        ...
        <div className="hidden sm:flex items-center gap-2 sm:gap-3">
          <a href="#login" className="px-4 py-2 sm:px-3 text-xs sm:text-sm border border-[#333] bg-[rgba(31,31,31,0.62)] text-gray-300 rounded-full hover:border-white/50 hover:text-white transition-colors duration-200 w-full sm:w-auto">
            Log In
          </a>
        </div>
...
export const SignInPage = ({ className, onLoginSuccess }: SignInPageProps) => {
  ...
  return (
    <div className={cn("flex w-[100%] flex-col min-h-screen bg-black relative", className)} id="login">
        ...
        {initialCanvasVisible && (
          <div className="absolute inset-0">
            <CanvasRevealEffect
              ...
              colors={[[128, 0, 0], [179, 0, 0]]} /* Maroon theme applied! */
              dotSize={6}
              reverse={false}
            />
          </div>
                ...
                {step === "email" ? (
                  ...
                  >
                    <div className="space-y-1">
                      <h1 className="text-[2.5rem] font-bold leading-[1.1] tracking-tight text-white">IntelliTract</h1>
                      <p className="text-[1.8rem] text-white/70 font-light">Agile Intelligence Platform</p>
                    </div>
                    ...
                    <p className="text-xs text-white/40 pt-10">
                      By signing up, you agree to the <a href="#" className="underline text-white/40 hover:text-white/60 transition-colors">MSA</a>.
                    </p>
                  </motion.div>
                ) : step === "code" ? (
                  <motion.div 
                  ...
                  >
                    <div className="space-y-1">
                      ...
                      <p className="text-[1.25rem] text-white/50 font-light">Please enter it (try 123456)</p>
                    </div>
